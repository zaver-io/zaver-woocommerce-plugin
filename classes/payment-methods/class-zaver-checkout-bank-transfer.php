 ...
 * The Zaver Checkout payment gateway.
 */
class Zaver_Checkout_Bank_Transfer extends WC_Payment_Gateway {
	...
	public function init_form_fields() {
		$this->form_fields = include ZCO_PLUGIN_PATH . '/includes/zaver-checkout-bank-transfer-settings.php';
	}
	...
	public function is_available() {
		return apply_filters( 'zaver_checkout_bank_transfer_is_available', $this->check_availability(), $this );
	}

	/**
	 * Check if the gateway should be available.
	 *
	 * This function is extracted to create the 'zaver_checkout_bank_transfer_is_available' filter.
	 *
	 * @return bool
	 */
